(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('techPosTestOtomasyonApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-techPosTestOtomasyonApp-error');
                var entityKey = httpResponse.headers('X-techPosTestOtomasyonApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('techPosTestOtomasyonApp.' + fieldError.objectName + '.' + convertedField);
